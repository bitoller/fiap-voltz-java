...
public class Transaction {
    ...
    public Integer getSourceWalletId() { return sourceWalletId; }
    public void setSourceWalletId(Integer sourceWalletId) { this.sourceWalletId = sourceWalletId; }
    public Integer getDestinationWalletId() { return destinationWalletId; }
    public void setDestinationWalletId(Integer destinationWalletId) { this.destinationWalletId = destinationWalletId; }
